...
r('DAS GROSSE C','Außen links beginnen, unten durch das C, rechts hinauf und über das Dach zurück zur Tür.',[70,480],[760,300],[f(32,480,190),f(210,480,540),[210,300,630,30],c(210,300,12),[210,300,12,130],f(750,480,50),f(800,430,40),f(840,380,40),f(880,330,48)],[h(160,480,27),h(470,480,27,z(405,430,70,70)),h(650,330,36,null,{dir:'down'})]);
r('ZURÜCK ZUM ANFANG','Oben weg vom Ziel, rechts hinab und unten durch eine doppelte Zahnlinie zurück.',[70,270],[86,455],[[32,270,690,28],f(722,455,206),f(32,455,610)],[h(350,270,27),h(420,455,27),h(210,455,27,z(500,405,95,70),{delay:.12})]);
r('DER SCHACHT','Drei sichtbare Seitenzähne erzwingen links-rechts-links Korrekturen im freien Fall.',[465,180],[690,468],[c(32,540,385),c(543,400,385),f(543,468,385)],[h(417,245,54,null,{dir:'right'}),h(543,330,54,null,{dir:'left'}),h(417,410,54,null,{dir:'right'})]);
r('NICHTS PASSIERT','Der lange Schwebesteg hält – aber drei sichtbare Zähne lassen keinen gemütlichen Dauerlauf zu.',[80,350],[850,350],[f(32,350,210),[242,350,485,24,'honest-bridge'],f(727,350,201)],[h(350,350,27),h(535,350,27),h(790,350,27)],[],[],[],{functionalFloatIds:['honest-bridge']});
r('DAS GELERNTE','Drei Zähne kombinieren Sichtbarkeit, sichere Höhe und eine verräterische Absprungkante.',[70,455],[865,455],[f(32,455,260),f(340,405,270),f(680,455,248)],[h(190,455),h(558,405,27,z(515,360,60,65),{delay:.14}),h(760,455,36)]);
...
r('DIE FÄHRE DREHT UM','Eine dünne Fähre hängt allein im riesigen Leerraum, bremst vor dem Ziel und kehrt um.',[78,385],[866,385],[f(32,385,210),[242,385,150,22,'ferry'],f(745,385,183)],[],[m('ferry',{stand:'ferry'},[[330,0,2.05],[330,0,.28],[0,0,1.05]])]);
r('NACH UNTEN','Ein ehrlicher Aufzug führt diagonal gelesen in den unteren Gang.',[720,235],[90,455],[[650,235,278,24,'downlift'],f(32,455,500)],[],[m('downlift',{stand:'downlift'},[[-118,220,1.8]])]);
r('RÜCKWEG GESPERRT','Ein Bodenfeld schießt hinter dir als feste Rückwand in den engen Oberkorridor.',[72,445],[850,350],[f(32,445,260),f(292,445,70,'wall'),f(362,400,280),f(642,350,286),c(362,330,280)],[h(585,400,27,z(545,350,55,70))],[m('wall',z(375,370,85,100),[[0,-349,.72]],.12)]);
r('GEGEN DEN STROM','Der Hochsteg fährt erst rückwärts und stürzt dann diagonal in den engen Zielgang.',[78,300],[864,450],[[32,300,158,24],[232,300,260,20,'stream'],f(730,450,198),c(600,300,128)],[],[m('stream',{stand:'stream'},[[-42,0,1.35],[-42,0,.28],[238,150,1.35]])]);
